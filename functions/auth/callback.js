...
export async function onRequestGet({ request, env }) {
  ...
  await env.DB.prepare(
    ...
    isAdm ? "approved" : "pending", isAdm ? 1 : 0,
    randToken("uvt", 20), now
  ).run();
  ...
  headers.append("Set-Cookie", "ipua_oauth=; Path=/auth; Max-Age=0; HttpOnly; SameSite=Lax" +
