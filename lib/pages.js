...
import { CANON, BRAND, CATS, esc, html, timeAgo, fmtDate, pageShell, EYE } from "./site.js";
...
export async function listPage(context, catKey) {
  ...
  return html(pageShell({
    ...
    tkey: cat.tkey,
    desc: BRAND + " " + cat.label + "頻道 — " + cat.desc + "。",
