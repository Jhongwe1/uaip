...
const PG_CSS = `
  ...
  .pg-ta{flex:1;resize:none;border:1px solid var(--pgline);background:var(--field);color:var(--fg);border-radius:13px;
         padding:10px 14px;font-size:14.5px;font-family:inherit;line-height:1.6;outline:none;min-height:42px;max-height:160px;box-sizing:border-box;transition:border-color .15s,box-shadow .15s}
