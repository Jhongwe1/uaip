...
const PG_CSS = `
  ...
  .pg-send{width:42px;height:42px;flex:0 0 auto;border-radius:50%;border:1px solid var(--line2);background:var(--accent);
           color:var(--accent-fg);font-size:17px;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;font-family:inherit;transition:.15s}
  .pg-send:disabled{opacity:.35;cursor:default}
  .pg-send.stop{background:transparent;color:var(--fg);border-color:var(--line);font-size:13px}
  /* 手機：側欄變抽屜 */
